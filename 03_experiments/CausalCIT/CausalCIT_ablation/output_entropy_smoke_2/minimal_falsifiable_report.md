...
> 生成时间: 2026-08-10 17:35:25
> 数据集: syn_ood | 变体: ['gate_prior_only', 'full_v2'] | seed: [42]
...
|------|---------|---------|-------|----------------------|---------------------|-------|
| gate_prior_only | 0.9938 | 0.0000 | 是 | nan | nan | 1 |
| full_v2 | 0.9364 | 0.1781 | 否 | nan | nan | 1 |
