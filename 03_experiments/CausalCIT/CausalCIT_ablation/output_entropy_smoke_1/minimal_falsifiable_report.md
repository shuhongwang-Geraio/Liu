...
> 生成时间: 2026-08-10 17:08:01
> 数据集: syn_ood | 变体: ['full_v2', 'gate_prior_only'] | seed: [42]
...
|------|---------|---------|-------|----------------------|---------------------|-------|
| full_v2 | 0.9538 | 0.1673 | 否 | nan | nan | 1 |
